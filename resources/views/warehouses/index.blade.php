...
<div
    ...
    <table class="w-full text-left">
        <thead class="bg-slate-50/50 dark:bg-slate-800/30 border-b border-slate-200 dark:border-slate-800">
            <tr>
                <th class="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Warehouse Name
                </th>
                <th class="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Location Code
                </th>
                <th class="px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">City / Region
                </th>
                ...
                <td colspan="4" class="px-8 py-20 text-center text-slate-500 italic">
                    <div class="flex flex-col items-center">
                        <div
                            ...
                            🏢</div>
                        <h4 class="text-lg font-black text-slate-900 dark:text-white tracking-tight">No Warehouses</h4>
                        <p class="text-sm text-slate-500 mt-1">Establish your first warehouse node to start managing
                            inventory.</p>
                    </div>
                </td>
            </tr>
